      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_260px] gap-6 items-start">
          ...
          <TabsContent value="prompt" className="space-y-3 pt-3">
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button
                ...
                className="bg-app-primary2 hover:bg-app-primary3 text-white flex items-center gap-2"
              >
                {busy ? (
                    ...
                    <button
                      ...
                      className={`w-14 h-14 rounded-full flex items-center justify-center shadow transition-colors ${
                        isRecording
                          ...
                          : "bg-app-primary2 hover:bg-app-primary3"
                      }`}
                    >
                      {isRecording ? (
        ...
        <div className="bg-slate-50/70 border border-slate-200 rounded-lg p-4 space-y-3 h-fit">
          ...
          <ul className="space-y-2 text-[11px] text-slate-500 leading-relaxed list-disc pl-4">
            <li>
              Only updates this item's photo — food name and nutrition stay
              untouched.
            </li>
            <li>
              Each regenerate uses a real (paid) AI image call, so use it
              deliberately rather than repeatedly.
            </li>
            <li>
              "Cancel" only stops waiting here — a generation already running
              still finishes in the background and the photo updates
