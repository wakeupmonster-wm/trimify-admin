...
export function PerformanceInsights({ data }) {
  ...
  return (
    <Card className="flex flex-col h-full bg-white border border-slate-200 hover:border-brand-aqua/50 transition-all duration-300 shadow-sm rounded-2xl">
      ...
      <CardFooter className="pt-2">
        <div className="mt-2 w-full flex items-center gap-2 px-3 py-2 bg-brand-aqua/5 border border-brand-aqua/40 rounded-xl text-muted-foreground text-[10px] font-bold">
