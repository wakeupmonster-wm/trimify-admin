...
const TONE_STYLES = {
  default: { iconBg: "bg-blue-50", iconColor: "text-brand-blue", border: "border-slate-200 hover:border-brand-blue" },
  emerald: { iconBg: "bg-emerald-50", iconColor: "text-emerald-600", border: "border-slate-200 hover:border-emerald-300" },
  amber: { iconBg: "bg-amber-50", iconColor: "text-amber-600", border: "border-amber-200 hover:border-amber-400" },
