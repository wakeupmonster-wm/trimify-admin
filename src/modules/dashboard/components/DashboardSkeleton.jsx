...
export const DashboardSkeleton = () => {
  return (
    <div className="flex flex-col gap-4 3xl:gap-6 py-5 px-4 lg:px-6 w-full max-w-full mx-auto">
      ...
      <Card className="border border-slate-200 bg-white rounded-2xl shadow-sm h-24">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 3xl:gap-6 w-full items-stretch">
          <Card className="border border-slate-200 bg-white rounded-2xl shadow-sm h-[420px]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 3xl:gap-6 w-full items-stretch">
        ...
        <div className="lg:col-span-4">
          <Card className="border border-slate-200 bg-white rounded-2xl shadow-sm h-[560px]">
            <CardHeader className="pb-4">
        ...
        <div className="lg:col-span-8 flex flex-col gap-4 3xl:gap-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 3xl:gap-6">
            <Card className="border border-slate-200 bg-white rounded-2xl shadow-sm h-[225px]">
              <CardHeader className="pb-4">
                <Skeleton className="h-5 w-32" />
              </CardHeader>
          ...
          <Card className="border border-slate-200 bg-white rounded-2xl shadow-sm h-[320px]">
            <CardHeader className="pb-4">
              <Skeleton className="h-5 w-48" />
            </CardHeader>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 3xl:gap-6">
        <Card className="border border-slate-200 bg-white rounded-2xl shadow-sm h-[480px]">
          <CardHeader className="pb-4">
            <Skeleton className="h-5 w-48" />
          </CardHeader>
