...
const KPI_CONFIG = [
  ...
  // },
  {
    ...
    isCurrency: false,
    onClick: (navigate) => navigate("/admin/users", { state: { filterId: "missed_step_goals" } }),
  },
  {
    key: "missedDietLogs",
    ...
    isCurrency: false,
    onClick: (navigate) => navigate("/admin/users", { state: { filterId: "missed_diet_logs" } }),
  },
  {
    key: "missedWaterLogs",
    ...
    isCurrency: false,
    onClick: (navigate) => navigate("/admin/users", { state: { filterId: "missed_water_logs" } }),
  },
  {
    key: "expiringSoon",
    label: "Expiring Soon",
