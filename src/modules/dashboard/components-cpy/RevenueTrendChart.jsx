...
export function RevenueTrendChart({ data }) {
  ...
  return (
    <Card className="rounded-xl border border-slate-300/60 hover:border-brand-aqua/50 transition-all duration-300 shadow-sm py-5 bg-white overflow-hidden flex flex-col h-full gap-0">
              ...
              >
                <defs>
                  <linearGradient id="colorRevenue" x1="0" y1="0" x2="0" y2="1">
                    ...
                    <stop offset="5%" stopColor="#15B097" stopOpacity={0.3} />
                    {/* <stop offset="95%" stopColor="#10b981" stopOpacity={0}/> */}
                    <stop offset="95%" stopColor="#15B097" stopOpacity={0} />
                  </linearGradient>
                </defs>
                <CartesianGrid
                  vertical={false}
