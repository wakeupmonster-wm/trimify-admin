...
export function PerformanceInsights({ data }) {
  ...
  return (
    <Card className="flex flex-col h-full bg-white border border-slate-300/60 hover:border-app-primary2 transition-all duration-300 shadow-sm rounded-2xl">
      ...
      <CardFooter className="pt-2">
        <div className="mt-2 w-full flex items-center gap-2 px-3 py-2 bg-app-primary2 border border-app-primary2 rounded-xl text-muted-foreground text-[10px] font-bold">
