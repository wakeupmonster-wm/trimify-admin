  ...
  return (
    <SectionCard title="Subscription" subheading="Current plan and billing status" icon={CreditCard}>
       <div className="flex flex-col">
         <ListItem icon={CreditCard} label="Current Plan" value={userData.plan || "Free"} badge={
            <Badge className="bg-slate-100 text-slate-600 border-none font-bold text-[9px] rounded px-1.5 py-0">Free</Badge>
         } />
