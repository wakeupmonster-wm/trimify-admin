...
//           };
//           const activeRingTones = {
//             blue: "ring-1 ring-offset-0 ring-app-primary2 border-app-primary2/50",
//             purple: "ring-1 ring-offset-0 ring-purple-500 border-purple-500/50",
//             emerald: "ring-1 ring-offset-0 ring-emerald-500 border-emerald-500/50",
//             amber: "ring-1 ring-offset-0 ring-amber-500 border-amber-500/50",
//           };
//           const textTones = {
...
//               className={cn(
//                 "flex flex-col items-center justify-center px-6 py-4 rounded-2xl border border-slate-300/80 bg-white border-b-4 shadow-sm transition-all duration-300 outline-none",
//                 borderTones[c.tone] || borderTones.blue,
//                 isActive
//                   ? cn(activeRingTones[c.tone] || activeRingTones.blue, "shadow-md -translate-y-0.5")
