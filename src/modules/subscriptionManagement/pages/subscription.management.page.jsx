...
const SubscriptionManagementPage = () => {
    ...
    const { subscriptions, loading, pagination: serverPagination } = useSelector((state) => state.subscriptionManagement);
      ...
      <Container>
        <div className='space-y-8'>
          ...
          <DataTable
            columns={columns}
            data={subscriptions || []}
            rowCount={serverPagination ? serverPagination.total : (subscriptions?.length || 0)}
