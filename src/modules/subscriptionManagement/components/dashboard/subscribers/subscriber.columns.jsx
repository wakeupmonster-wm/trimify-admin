...
import { MoreVertical, ArrowUpCircle, CalendarOff, ShieldOff } from "lucide-react";
      ...
      return (
        <div className="flex justify-center">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-44 p-1.5 rounded-xl border-slate-200 shadow-sm">
