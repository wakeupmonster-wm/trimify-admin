...
export default function DashboardHeader({ scrolled, dateRange, onDateChange, onRefresh, refreshing }) {
  return (
    <header
      className={cn(
    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 w-full">
        ...
        <div className="flex items-center gap-2.5 w-full sm:w-auto">
          <CalendarDateRangePicker value={dateRange} onDateChange={onDateChange} className="flex-1 sm:flex-none sm:w-64" />
          <Button
            type="button"
            variant="outline"
            onClick={onRefresh}
