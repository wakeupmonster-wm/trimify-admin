...
export const SocialInput = ({
  ...
  <div className="space-y-2">
    ...
    <div className="flex items-stretch w-full rounded-lg border border-slate-300/60 overflow-hidden group focus-within:border-brand-blue focus-within:ring-4 focus-within:ring-brand-blue transition-all duration-300">
