    ...
    <div className="min-h-screen bg-[#F8FDFF] flex flex-col items-center justify-center px-6 py-12 text-center relative overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-2">
          {isChunkError ? (
            <Button
              className="bg-app-primary2 hover:bg-app-primary3 text-white h-12 px-8 rounded-full font-bold shadow-lg shadow-[#46C7CD]/20 transition-all transform hover:scale-105 flex items-center gap-2"
          ...
          <Button
            variant="outline"
            className="border-app-primary2 text-app-primary2 hover:bg-app-primary3 hover:text-white h-12 px-6 rounded-full font-bold transition-all flex items-center gap-2"
