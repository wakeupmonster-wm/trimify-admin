            ...
            <div className="flex items-center gap-2 w-full md:w-auto">
              ...
              <DropdownMenu>
                    ...
                    <span className="text-xs">
                      {filters.statusFilter
                        ? filters.statusFilter
                            ...
                            .charAt(0)
                            .toUpperCase() +
                          filters.statusFilter.replace("_", " ").slice(1)
                        : "All Status"}
                    </span>
                ...
                >
                  ...
                  {["not_started", "pending", "approved", "rejected"].map(
                    (status) => (
                      <DropdownMenuCheckboxItem
                        key={status}
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    ...
                    className={cn(
                      "h-9 3xl:h-10 px-3 3xl:px-4 gap-2 bg-white border-slate-200 text-slate-600 font-medium rounded-md hover:bg-slate-50 transition-all w-full md:w-auto justify-between",
                      filters.sortBy && "border-brand-aqua text-brand-aqua",
                    )}
                  >
                    <span className="text-xs">
                      {filters.sortBy
                        ? [
                          ...
                          ].find((opt) => opt.id === filters.sortBy)?.label
                        : "Sort Order"}
                    </span>
                    <IconChevronDown className="h-4 w-4 opacity-50" />
                  </Button>
                ...
                <DropdownMenuContent
                  align="end"
                  className="w-36 p-1.5 rounded-xl text-xs"
                >
                  <DropdownMenuLabel className="text-[10px] font-bold text-slate-400 uppercase px-2 py-1.5">
                    Sort Order
                  </DropdownMenuLabel>
                  {[
                    ...
                    <DropdownMenuCheckboxItem
                      ...
                      onCheckedChange={() => filters.setSortBy(opt.id)}
                    >
                      {opt.label}
                    </DropdownMenuCheckboxItem>
                  ))}
