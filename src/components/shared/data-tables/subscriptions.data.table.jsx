                ...
                <DropdownMenuTrigger asChild>
                  <Button
                    ...
                    className={cn(
                      ...
                      filters.status && "border-app-primary2 text-app-primary2",
                    )}
                  >
                ...
                >
                  ...
                  {["ACTIVE", "EXPIRED", "CANCELLED", "PENDING"].map((s) => (
                    <DropdownMenuCheckboxItem
                      ...
                      onCheckedChange={() => filters.setStatus(s)}
                    >
                      {s}
                    </DropdownMenuCheckboxItem>
                  ))}
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    ...
                    className={cn(
                      "h-9 3xl:h-10 px-3 3xl:px-4 gap-2 bg-white border-slate-300/60 text-slate-600 font-medium rounded-md hover:bg-slate-50 transition-all w-full md:w-auto justify-between",
                      filters.plan && "border-app-primary2 text-app-primary2",
                    )}
                  >
                    <span className="text-sm">
                      {filters.plan
                        ? filters.plan.charAt(0).toUpperCase() +
                          filters.plan.slice(1)
                        : "All Plans"}
                    </span>
                    <IconChevronDown className="h-4 w-4 opacity-50" />
                  </Button>
                ...
                >
                  ...
                  {["weekly", "monthly", "yearly", "lifetime"].map((p) => (
                    <DropdownMenuCheckboxItem
                      ...
                      onCheckedChange={() => filters.setPlan(p)}
                    >
                      {p}
                    </DropdownMenuCheckboxItem>
                  ))}
              ...
              <DropdownMenu>
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      {filters.platform === "android" && (
                        <AiFillAndroid className="w-3.5 h-3.5 text-emerald-600" />
                      )}
                      <span className="text-sm">
                        {filters.platform
                          ? filters.platform.toUpperCase()
                          : "All Platforms"}
                      </span>
                    </div>
                    <IconChevronDown className="h-4 w-4 opacity-50" />
                ...
                >
                  ...
                  <DropdownMenuCheckboxItem
                    ...
                    onCheckedChange={() => filters.setPlatform("ios")}
                  >
                    <div className="flex items-center gap-2">
                  ...
                  <DropdownMenuCheckboxItem
                    ...
                    onCheckedChange={() => filters.setPlatform("android")}
                  >
                    <div className="flex items-center gap-2">
              ...
              <AnimatePresence mode="popLayout">
                {table.getRowModel().rows?.length ? (
                  ...
                  <TableRow>
                    ...
                    >
                      {isLoading ? (
                        <TableLoader text="Fetching Subscriptions..." />
                      ) : (
                        <DataNotFound message="No subscriptions found" />
                      )}
                    </TableCell>
                  </TableRow>
                )}
