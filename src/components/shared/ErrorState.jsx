...
export default function ErrorState({ error, fetchVisitorData }) {
  return (
    ...
    >
      <Card className="rounded-[35px] border border-slate-300/60/60 shadow-xl shadow-slate-200/50 bg-white overflow-hidden relative">
        ...
        <div className="absolute bottom-0 left-0 w-full opacity-[0.06] bg-app-primary2 pointer-events-none">
